module.exports = {
  BIG4_BANK_ABBRS: ["ANZ", "CBA", "NAB", "WBA"],
  BIG4_BANK_HOLDERS: {
    ANZ: "https://API.anz",
  ...
  DO_NOT_APPLY_PAGINATON_ERROR_MSG:
    "Invalid argument provided, do not change page size or page number",
};
